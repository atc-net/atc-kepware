...
public static class CommandAppExtensions
{
    ...
    {
        node
            .AddCommand<ChannelGetAllenBradleyControlLogixEthernetCommand>("allenbradleycontrollogixethernet")
        ...
        node
            .AddCommand<ChannelGetAllenBradleyControlLogixServerEthernetCommand>("allenbradleycontrollogixserverethernet")
        ...
        node
            .AddCommand<ChannelGetAllenBradleyEthernetCommand>("allenbradleyethernet")
        ...
        node
            .AddCommand<ChannelGetAllenBradleyMicro800EthernetCommand>("allenbradleymicro800ethernet")
        ...
        node
            .AddCommand<ChannelGetAllenBradleyServerEthernetCommand>("allenbradleyserverethernet")
    ...
    {
        node
            .AddCommand<ChannelGetSiemensS7PlusEthernetCommand>("siemenss7plusethernet")
        ...
        node
            .AddCommand<ChannelGetSiemensTcpIpEthernetCommand>("siemenstcpipethernet")
        ...
        node
            .AddCommand<ChannelGetSiemensTcpIpServerEthernetCommand>("siemenstcpipserverethernet")
        ...
        node
            .AddCommand<ChannelGetSimaticTi505EthernetCommand>("simaticti505ethernet")
    ...
    {
        node
            .AddCommand<ChannelGetMitsubishiCncEthernetCommand>("mitsubishicncethernet")
        ...
        node
            .AddCommand<ChannelGetMitsubishiEthernetCommand>("mitsubishiethernet")
        ...
        node
            .AddCommand<ChannelGetMitsubishiFxNetCommand>("mitsubishifxnet")
    ...
    {
        node
            .AddCommand<ChannelGetOmronFinsEthernetCommand>("omronfinsethernet")
        ...
        node
            .AddCommand<ChannelGetOmronNjEthernetCommand>("omronnjethernet")
    ...
    {
        node
            .AddCommand<ChannelGetYokogawaCxEthernetCommand>("yokogawacxethernet")
        ...
        node
            .AddCommand<ChannelGetYokogawaDarwinEthernetCommand>("yokogawadarwinethernet")
        ...
        node
            .AddCommand<ChannelGetYokogawaDxEthernetCommand>("yokogawadxethernet")
        ...
        node
            .AddCommand<ChannelGetYokogawaDxpEthernetCommand>("yokogawadxpethernet")
        ...
        node
            .AddCommand<ChannelGetYokogawaGxEthernetCommand>("yokogawagxethernet")
        ...
        node
            .AddCommand<ChannelGetYokogawaMwEthernetCommand>("yokogawamwethernet")
        ...
        node
            .AddCommand<ChannelGetYokogawaMxEthernetCommand>("yokogawamxethernet")
    ...
    {
        node
            .AddCommand<ChannelGetHoneywellHc900EthernetCommand>("honeywellhc900ethernet")
        ...
        node
            .AddCommand<ChannelGetHoneywellUdcEthernetCommand>("honeywelludcethernet")
        ...
        IConfigurator<CommandSettings> node)
    {
        ...
        node
            .AddCommand<ChannelGetIec608705104ClientCommand>("iec608705104client")
        ...
        node
            .AddCommand<ChannelGetIec61850MmsClientCommand>("iec61850mmsclient")
        ...
        node
            .AddCommand<ChannelGetModbusTcpIpEthernetCommand>("modbustcpipethernet")
        ...
        node
            .AddCommand<ChannelGetSnmpCommand>("snmp")
    ...
    {
        node
            .AddCommand<ChannelGetOpcDaClientCommand>("opcdaclient")
        ...
        node
            .AddCommand<ChannelGetOpcUaClientCommand>("opcuaclient")
        ...
        node
            .AddCommand<ChannelGetOpcXmlDaClientCommand>("opcxmldaclient")
    ...
    {
        node
            .AddCommand<ChannelGetEuroMap63Command>("euromap63")
            .WithDescription("Get a EuroMap63 channel.")
            .WithExample("connectivity channels get euromap63 -s [server-url] --name [channelName]");

        node
            .AddCommand<ChannelGetKraussMaffeiMc4EthernetCommand>("kraussmaffeimc4ethernet")
    ...
    {
        node
            .AddCommand<ChannelGetAutomationDirectEbcCommand>("automationdirectebc")
        ...
        node
            .AddCommand<ChannelGetAutomationDirectEcomCommand>("automationdirectecom")
        ...
        node
            .AddCommand<ChannelGetAutomationDirectProductivitySeriesEthernetCommand>("automationdirectproductivityseriesethernet")
        ...
        node
            .AddCommand<ChannelGetBeckhoffTwinCatCommand>("beckhofftwincat")
        ...
        node
            .AddCommand<ChannelGetCodesysCommand>("codesys")
            .WithDescription("Get a CODESYS channel.")
            .WithExample("connectivity channels get codesys -s [server-url] --name [channelName]");

        node
            .AddCommand<ChannelGetCutlerHammerElcEthernetCommand>("cutlerhammerelcethernet")
        ...
        node
            .AddCommand<ChannelGetKeyenceKvEthernetCommand>("keyencekvethernet")
        ...
        node
            .AddCommand<ChannelGetOpto22EthernetCommand>("opto22ethernet")
        ...
        node
            .AddCommand<ChannelGetSixnetEthertrakCommand>("sixnetethertrak")
        ...
        node
            .AddCommand<ChannelGetToyopucEthernetCommand>("toyopucethernet")
        ...
        node
            .AddCommand<ChannelGetTriconexEthernetCommand>("triconexethernet")
        ...
        node
            .AddCommand<ChannelGetWagoEthernetCommand>("wagoethernet")
        ...
        node
            .AddCommand<ChannelGetYaskawaMpSeriesEthernetCommand>("yaskawampseriesethernet")
    ...
    {
        node
            .AddCommand<ChannelGetAlstomRedundantEthernetCommand>("alstomredundantethernet")
        ...
        node
            .AddCommand<ChannelGetAromatEthernetCommand>("aromatethernet")
        ...
        node
            .AddCommand<ChannelGetBristolBsapIpCommand>("bristolbsapip")
        ...
        node
            .AddCommand<ChannelGetBuswareEthernetCommand>("buswareethernet")
        ...
        node
            .AddCommand<ChannelGetFanucFocasEthernetCommand>("fanucfocasethernet")
        ...
        node
            .AddCommand<ChannelGetSattBusEthernetCommand>("sattbusethernet")
        ...
        node
            .AddCommand<ChannelGetScanivalveEthernetCommand>("scanivalveethernet")
        ...
        node
            .AddCommand<ChannelGetThermoWestronicsEthernetCommand>("thermowestronicsethernet")
        ...
        node
            .AddCommand<ChannelGetTorqueToolEthernetCommand>("torquetoolethernet")
        ...
        node
            .AddCommand<ChannelGetToshibaEthernetCommand>("toshibaethernet")
        ...
        node
            .AddCommand<ChannelGetWonderwareIntouchClientCommand>("wonderwareintouchclient")
    ...
    {
        node
            .AddCommand<ChannelCreateAllenBradleyControlLogixEthernetCommand>("allenbradleycontrollogixethernet")
        ...
        node
            .AddCommand<ChannelCreateAllenBradleyControlLogixServerEthernetCommand>("allenbradleycontrollogixserverethernet")
        ...
        node
            .AddCommand<ChannelCreateAllenBradleyEthernetCommand>("allenbradleyethernet")
        ...
        node
            .AddCommand<ChannelCreateAllenBradleyMicro800EthernetCommand>("allenbradleymicro800ethernet")
        ...
        node
            .AddCommand<ChannelCreateAllenBradleyServerEthernetCommand>("allenbradleyserverethernet")
    ...
    {
        node
            .AddCommand<ChannelCreateSiemensS7PlusEthernetCommand>("siemenss7plusethernet")
        ...
        node
            .AddCommand<ChannelCreateSiemensTcpIpEthernetCommand>("siemenstcpipethernet")
        ...
        node
            .AddCommand<ChannelCreateSiemensTcpIpServerEthernetCommand>("siemenstcpipserverethernet")
        ...
        node
            .AddCommand<ChannelCreateSimaticTi505EthernetCommand>("simaticti505ethernet")
    ...
    {
        node
            .AddCommand<ChannelCreateMitsubishiCncEthernetCommand>("mitsubishicncethernet")
        ...
        node
            .AddCommand<ChannelCreateMitsubishiEthernetCommand>("mitsubishiethernet")
        ...
        node
            .AddCommand<ChannelCreateMitsubishiFxNetCommand>("mitsubishifxnet")
    ...
    {
        node
            .AddCommand<ChannelCreateOmronFinsEthernetCommand>("omronfinsethernet")
        ...
        node
            .AddCommand<ChannelCreateOmronNjEthernetCommand>("omronnjethernet")
    ...
    {
        node
            .AddCommand<ChannelCreateYokogawaCxEthernetCommand>("yokogawacxethernet")
        ...
        node
            .AddCommand<ChannelCreateYokogawaDarwinEthernetCommand>("yokogawadarwinethernet")
        ...
        node
            .AddCommand<ChannelCreateYokogawaDxEthernetCommand>("yokogawadxethernet")
        ...
        node
            .AddCommand<ChannelCreateYokogawaDxpEthernetCommand>("yokogawadxpethernet")
        ...
        node
            .AddCommand<ChannelCreateYokogawaGxEthernetCommand>("yokogawagxethernet")
        ...
        node
            .AddCommand<ChannelCreateYokogawaMwEthernetCommand>("yokogawamwethernet")
        ...
        node
            .AddCommand<ChannelCreateYokogawaMxEthernetCommand>("yokogawamxethernet")
    ...
    {
        node
            .AddCommand<ChannelCreateHoneywellHc900EthernetCommand>("honeywellhc900ethernet")
        ...
        node
            .AddCommand<ChannelCreateHoneywellUdcEthernetCommand>("honeywelludcethernet")
    ...
    {
        node
            .AddCommand<ChannelCreateGeEthernetCommand>("geethernet")
        ...
        node
            .AddCommand<ChannelCreateGeEthernetGlobalDataCommand>("geethernetglobaldata")
    ...
    {
        node
            .AddCommand<ChannelCreateBacNetIpCommand>("bacnetip")
        ...
        node
            .AddCommand<ChannelCreateDnpClientEthernetCommand>("dnpclientethernet")
        ...
        node
            .AddCommand<ChannelCreateIec608705104ClientCommand>("iec608705104client")
        ...
        node
            .AddCommand<ChannelCreateIec61850MmsClientCommand>("iec61850mmsclient")
        ...
        node
            .AddCommand<ChannelCreateModbusTcpIpEthernetCommand>("modbustcpipethernet")
        ...
        node
            .AddCommand<ChannelCreateSnmpCommand>("snmp")
    ...
    {
        node
            .AddCommand<ChannelCreateOpcDaClientCommand>("opcdaclient")
        ...
        node
            .AddCommand<ChannelCreateOpcUaClientCommand>("opcuaclient")
        ...
        node
            .AddCommand<ChannelCreateOpcXmlDaClientCommand>("opcxmldaclient")
    ...
    {
        node
            .AddCommand<ChannelCreateEuroMap63Command>("euromap63")
        ...
        node
            .AddCommand<ChannelCreateKraussMaffeiMc4EthernetCommand>("kraussmaffeimc4ethernet")
        ...
        node
            .AddCommand<ChannelCreateMqttClientCommand>("mqttclient")
        ...
        node
            .AddCommand<ChannelCreateMtConnectClientCommand>("mtconnectclient")
    ...
    {
        node
            .AddCommand<ChannelCreateAutomationDirectEbcCommand>("automationdirectebc")
        ...
        node
            .AddCommand<ChannelCreateAutomationDirectEcomCommand>("automationdirectecom")
        ...
        node
            .AddCommand<ChannelCreateAutomationDirectProductivitySeriesEthernetCommand>("automationdirectproductivityseriesethernet")
        ...
        node
            .AddCommand<ChannelCreateBeckhoffTwinCatCommand>("beckhofftwincat")
        ...
        node
            .AddCommand<ChannelCreateCodesysCommand>("codesys")
        ...
        node
            .AddCommand<ChannelCreateCutlerHammerElcEthernetCommand>("cutlerhammerelcethernet")
        ...
        node
            .AddCommand<ChannelCreateKeyenceKvEthernetCommand>("keyencekvethernet")
        ...
        node
            .AddCommand<ChannelCreateOpto22EthernetCommand>("opto22ethernet")
        ...
        node
            .AddCommand<ChannelCreateSixnetEthertrakCommand>("sixnetethertrak")
        ...
        node
            .AddCommand<ChannelCreateToyopucEthernetCommand>("toyopucethernet")
        ...
        node
            .AddCommand<ChannelCreateTriconexEthernetCommand>("triconexethernet")
        ...
        node
            .AddCommand<ChannelCreateWagoEthernetCommand>("wagoethernet")
        ...
        node
            .AddCommand<ChannelCreateYaskawaMpSeriesEthernetCommand>("yaskawampseriesethernet")
    ...
    {
        node
            .AddCommand<ChannelCreateAlstomRedundantEthernetCommand>("alstomredundantethernet")
        ...
        node
            .AddCommand<ChannelCreateAromatEthernetCommand>("aromatethernet")
        ...
        node
            .AddCommand<ChannelCreateBristolBsapIpCommand>("bristolbsapip")
        ...
        node
            .AddCommand<ChannelCreateBuswareEthernetCommand>("buswareethernet")
        ...
        node
            .AddCommand<ChannelCreateFanucFocasEthernetCommand>("fanucfocasethernet")
        ...
        node
            .AddCommand<ChannelCreateSattBusEthernetCommand>("sattbusethernet")
        ...
        node
            .AddCommand<ChannelCreateScanivalveEthernetCommand>("scanivalveethernet")
        ...
        node
            .AddCommand<ChannelCreateThermoWestronicsEthernetCommand>("thermowestronicsethernet")
        ...
        node
            .AddCommand<ChannelCreateTorqueToolEthernetCommand>("torquetoolethernet")
        ...
        node
            .AddCommand<ChannelCreateToshibaEthernetCommand>("toshibaethernet")
        ...
        node
            .AddCommand<ChannelCreateWonderwareIntouchClientCommand>("wonderwareintouchclient")
    ...
    {
        node
            .AddCommand<DeviceGetAllenBradleyControlLogixEthernetCommand>("allenbradleycontrollogixethernet")
        ...
        node
            .AddCommand<DeviceGetAllenBradleyControlLogixServerEthernetCommand>("allenbradleycontrollogixserverethernet")
        ...
        node
            .AddCommand<DeviceGetAllenBradleyEthernetCommand>("allenbradleyethernet")
        ...
        node
            .AddCommand<DeviceGetAllenBradleyMicro800EthernetCommand>("allenbradleymicro800ethernet")
        ...
        node
            .AddCommand<DeviceGetAllenBradleyServerEthernetCommand>("allenbradleyserverethernet")
    ...
    {
        node
            .AddCommand<DeviceGetSiemensS7PlusEthernetCommand>("siemenss7plusethernet")
        ...
        node
            .AddCommand<DeviceGetSiemensTcpIpEthernetCommand>("siemenstcpipethernet")
        ...
        node
            .AddCommand<DeviceGetSiemensTcpIpServerEthernetCommand>("siemenstcpipserverethernet")
        ...
        node
            .AddCommand<DeviceGetSimaticTi505EthernetCommand>("simaticti505ethernet")
    ...
    {
        node
            .AddCommand<DeviceGetMitsubishiCncEthernetCommand>("mitsubishicncethernet")
        ...
        node
            .AddCommand<DeviceGetMitsubishiEthernetCommand>("mitsubishiethernet")
        ...
        node
            .AddCommand<DeviceGetMitsubishiFxNetCommand>("mitsubishifxnet")
    ...
    {
        node
            .AddCommand<DeviceGetOmronFinsEthernetCommand>("omronfinsethernet")
        ...
        node
            .AddCommand<DeviceGetOmronNjEthernetCommand>("omronnjethernet")
    ...
    {
        node
            .AddCommand<DeviceGetYokogawaCxEthernetCommand>("yokogawacxethernet")
        ...
        node
            .AddCommand<DeviceGetYokogawaDarwinEthernetCommand>("yokogawadarwinethernet")
        ...
        node
            .AddCommand<DeviceGetYokogawaDxEthernetCommand>("yokogawadxethernet")
        ...
        node
            .AddCommand<DeviceGetYokogawaDxpEthernetCommand>("yokogawadxpethernet")
        ...
        node
            .AddCommand<DeviceGetYokogawaGxEthernetCommand>("yokogawagxethernet")
        ...
        node
            .AddCommand<DeviceGetYokogawaMwEthernetCommand>("yokogawamwethernet")
        ...
        node
            .AddCommand<DeviceGetYokogawaMxEthernetCommand>("yokogawamxethernet")
    ...
    {
        node
            .AddCommand<DeviceGetHoneywellHc900EthernetCommand>("honeywellhc900ethernet")
        ...
        node
            .AddCommand<DeviceGetHoneywellUdcEthernetCommand>("honeywelludcethernet")
    ...
    {
        node
            .AddCommand<DeviceGetGeEthernetCommand>("geethernet")
        ...
        node
            .AddCommand<DeviceGetGeEthernetGlobalDataCommand>("geethernetglobaldata")
    ...
    {
        node
            .AddCommand<DeviceGetBacNetIpCommand>("bacnetip")
        ...
        node
            .AddCommand<DeviceGetDnpClientEthernetCommand>("dnpclientethernet")
        ...
        node
            .AddCommand<DeviceGetIec608705104ClientCommand>("iec608705104client")
        ...
        node
            .AddCommand<DeviceGetIec61850MmsClientCommand>("iec61850mmsclient")
        ...
        node
            .AddCommand<DeviceGetModbusTcpIpEthernetCommand>("modbustcpipethernet")
        ...
        node
            .AddCommand<DeviceGetSnmpCommand>("snmp")
    ...
    {
        node
            .AddCommand<DeviceGetOpcDaClientCommand>("opcdaclient")
        ...
        node
            .AddCommand<DeviceGetOpcUaClientCommand>("opcuaclient")
        ...
        node
            .AddCommand<DeviceGetOpcXmlDaClientCommand>("opcxmldaclient")
    ...
    {
        node
            .AddCommand<DeviceGetEuroMap63Command>("euromap63")
        ...
        node
            .AddCommand<DeviceGetKraussMaffeiMc4EthernetCommand>("kraussmaffeimc4ethernet")
        ...
        node
            .AddCommand<DeviceGetMqttClientCommand>("mqttclient")
        ...
        node
            .AddCommand<DeviceGetMtConnectClientCommand>("mtconnectclient")
    ...
    {
        node
            .AddCommand<DeviceGetAutomationDirectEbcCommand>("automationdirectebc")
        ...
        node
            .AddCommand<DeviceGetAutomationDirectEcomCommand>("automationdirectecom")
        ...
        node
            .AddCommand<DeviceGetAutomationDirectProductivitySeriesEthernetCommand>("automationdirectproductivityseriesethernet")
        ...
        node
            .AddCommand<DeviceGetBeckhoffTwinCatCommand>("beckhofftwincat")
        ...
        node
            .AddCommand<DeviceGetCodesysCommand>("codesys")
        ...
        node
            .AddCommand<DeviceGetCutlerHammerElcEthernetCommand>("cutlerhammerelcethernet")
        ...
        node
            .AddCommand<DeviceGetKeyenceKvEthernetCommand>("keyencekvethernet")
        ...
        node
            .AddCommand<DeviceGetOpto22EthernetCommand>("opto22ethernet")
        ...
        node
            .AddCommand<DeviceGetSixnetEthertrakCommand>("sixnetethertrak")
        ...
        node
            .AddCommand<DeviceGetToyopucEthernetCommand>("toyopucethernet")
        ...
        node
            .AddCommand<DeviceGetTriconexEthernetCommand>("triconexethernet")
        ...
        node
            .AddCommand<DeviceGetWagoEthernetCommand>("wagoethernet")
        ...
        node
            .AddCommand<DeviceGetYaskawaMpSeriesEthernetCommand>("yaskawampseriesethernet")
    ...
    {
        node
            .AddCommand<DeviceGetAlstomRedundantEthernetCommand>("alstomredundantethernet")
        ...
        node
            .AddCommand<DeviceGetAromatEthernetCommand>("aromatethernet")
        ...
        node
            .AddCommand<DeviceGetBristolBsapIpCommand>("bristolbsapip")
        ...
        node
            .AddCommand<DeviceGetBuswareEthernetCommand>("buswareethernet")
        ...
        node
            .AddCommand<DeviceGetFanucFocasEthernetCommand>("fanucfocasethernet")
        ...
        node
            .AddCommand<DeviceGetSattBusEthernetCommand>("sattbusethernet")
        ...
        node
            .AddCommand<DeviceGetScanivalveEthernetCommand>("scanivalveethernet")
        ...
        node
            .AddCommand<DeviceGetThermoWestronicsEthernetCommand>("thermowestronicsethernet")
        ...
        node
            .AddCommand<DeviceGetTorqueToolEthernetCommand>("torquetoolethernet")
        ...
        node
            .AddCommand<DeviceGetToshibaEthernetCommand>("toshibaethernet")
        ...
        node
            .AddCommand<DeviceGetWonderwareIntouchClientCommand>("wonderwareintouchclient")
    ...
    {
        node
            .AddCommand<DeviceCreateAllenBradleyControlLogixEthernetCommand>("allenbradleycontrollogixethernet")
        ...
        node
            .AddCommand<DeviceCreateAllenBradleyControlLogixServerEthernetCommand>("allenbradleycontrollogixserverethernet")
        ...
        node
            .AddCommand<DeviceCreateAllenBradleyEthernetCommand>("allenbradleyethernet")
        ...
        node
            .AddCommand<DeviceCreateAllenBradleyMicro800EthernetCommand>("allenbradleymicro800ethernet")
        ...
        node
            .AddCommand<DeviceCreateAllenBradleyServerEthernetCommand>("allenbradleyserverethernet")
    ...
    {
        node
            .AddCommand<DeviceCreateSiemensS7PlusEthernetCommand>("siemenss7plusethernet")
        ...
        node
            .AddCommand<DeviceCreateSiemensTcpIpEthernetCommand>("siemenstcpipethernet")
        ...
        node
            .AddCommand<DeviceCreateSiemensTcpIpServerEthernetCommand>("siemenstcpipserverethernet")
        ...
        node
            .AddCommand<DeviceCreateSimaticTi505EthernetCommand>("simaticti505ethernet")
    ...
    {
        node
            .AddCommand<DeviceCreateMitsubishiCncEthernetCommand>("mitsubishicncethernet")
        ...
        node
            .AddCommand<DeviceCreateMitsubishiEthernetCommand>("mitsubishiethernet")
        ...
        node
            .AddCommand<DeviceCreateMitsubishiFxNetCommand>("mitsubishifxnet")
    ...
    {
        node
            .AddCommand<DeviceCreateOmronFinsEthernetCommand>("omronfinsethernet")
        ...
        node
            .AddCommand<DeviceCreateOmronNjEthernetCommand>("omronnjethernet")
    ...
    {
        node
            .AddCommand<DeviceCreateYokogawaCxEthernetCommand>("yokogawacxethernet")
        ...
        node
            .AddCommand<DeviceCreateYokogawaDarwinEthernetCommand>("yokogawadarwinethernet")
        ...
        node
            .AddCommand<DeviceCreateYokogawaDxEthernetCommand>("yokogawadxethernet")
        ...
        node
            .AddCommand<DeviceCreateYokogawaDxpEthernetCommand>("yokogawadxpethernet")
        ...
        node
            .AddCommand<DeviceCreateYokogawaGxEthernetCommand>("yokogawagxethernet")
        ...
        node
            .AddCommand<DeviceCreateYokogawaMwEthernetCommand>("yokogawamwethernet")
        ...
        node
            .AddCommand<DeviceCreateYokogawaMxEthernetCommand>("yokogawamxethernet")
    ...
    {
        node
            .AddCommand<DeviceCreateHoneywellHc900EthernetCommand>("honeywellhc900ethernet")
        ...
        node
            .AddCommand<DeviceCreateHoneywellUdcEthernetCommand>("honeywelludcethernet")
    ...
    {
        node
            .AddCommand<DeviceCreateGeEthernetCommand>("geethernet")
        ...
        node
            .AddCommand<DeviceCreateGeEthernetGlobalDataCommand>("geethernetglobaldata")
    ...
    {
        node
            .AddCommand<DeviceCreateBacNetIpCommand>("bacnetip")
        ...
        node
            .AddCommand<DeviceCreateDnpClientEthernetCommand>("dnpclientethernet")
        ...
        node
            .AddCommand<DeviceCreateIec608705104ClientCommand>("iec608705104client")
        ...
        node
            .AddCommand<DeviceCreateIec61850MmsClientCommand>("iec61850mmsclient")
        ...
        node
            .AddCommand<DeviceCreateModbusTcpIpEthernetCommand>("modbustcpipethernet")
        ...
        node
            .AddCommand<DeviceCreateSnmpCommand>("snmp")
    ...
    {
        node
            .AddCommand<DeviceCreateOpcDaClientCommand>("opcdaclient")
        ...
        node
            .AddCommand<DeviceCreateOpcUaClientCommand>("opcuaclient")
        ...
        node
            .AddCommand<DeviceCreateOpcXmlDaClientCommand>("opcxmldaclient")
    ...
    {
        node
            .AddCommand<DeviceCreateEuroMap63Command>("euromap63")
        ...
        node
            .AddCommand<DeviceCreateKraussMaffeiMc4EthernetCommand>("kraussmaffeimc4ethernet")
        ...
        node
            .AddCommand<DeviceCreateMqttClientCommand>("mqttclient")
        ...
        node
            .AddCommand<DeviceCreateMtConnectClientCommand>("mtconnectclient")
        ...
        node
            .AddCommand<DeviceCreateOpto22EthernetCommand>("opto22ethernet")
    ...
    {
        node
            .AddCommand<DeviceCreateAutomationDirectEbcCommand>("automationdirectebc")
        ...
        node
            .AddCommand<DeviceCreateAutomationDirectEcomCommand>("automationdirectecom")
        ...
        node
            .AddCommand<DeviceCreateAutomationDirectProductivitySeriesEthernetCommand>("automationdirectproductivityseriesethernet")
        ...
        node
            .AddCommand<DeviceCreateBeckhoffTwinCatCommand>("beckhofftwincat")
        ...
        node
            .AddCommand<DeviceCreateCodesysCommand>("codesys")
        ...
        node
            .AddCommand<DeviceCreateCutlerHammerElcEthernetCommand>("cutlerhammerelcethernet")
        ...
        node
            .AddCommand<DeviceCreateKeyenceKvEthernetCommand>("keyencekvethernet")
        ...
        node
            .AddCommand<DeviceCreateSixnetEthertrakCommand>("sixnetethertrak")
        ...
        node
            .AddCommand<DeviceCreateToyopucEthernetCommand>("toyopucethernet")
        ...
        node
            .AddCommand<DeviceCreateTriconexEthernetCommand>("triconexethernet")
        ...
        node
            .AddCommand<DeviceCreateWagoEthernetCommand>("wagoethernet")
        ...
        node
            .AddCommand<DeviceCreateYaskawaMpSeriesEthernetCommand>("yaskawampseriesethernet")
    ...
    {
        node
            .AddCommand<DeviceCreateAlstomRedundantEthernetCommand>("alstomredundantethernet")
        ...
        node
            .AddCommand<DeviceCreateAromatEthernetCommand>("aromatethernet")
        ...
        node
            .AddCommand<DeviceCreateBristolBsapIpCommand>("bristolbsapip")
        ...
        node
            .AddCommand<DeviceCreateBuswareEthernetCommand>("buswareethernet")
        ...
        node
            .AddCommand<DeviceCreateFanucFocasEthernetCommand>("fanucfocasethernet")
        ...
        node
            .AddCommand<DeviceCreateSattBusEthernetCommand>("sattbusethernet")
        ...
        node
            .AddCommand<DeviceCreateScanivalveEthernetCommand>("scanivalveethernet")
        ...
        node
            .AddCommand<DeviceCreateThermoWestronicsEthernetCommand>("thermowestronicsethernet")
        ...
        node
            .AddCommand<DeviceCreateTorqueToolEthernetCommand>("torquetoolethernet")
        ...
        node
            .AddCommand<DeviceCreateToshibaEthernetCommand>("toshibaethernet")
        ...
        node
            .AddCommand<DeviceCreateWonderwareIntouchClientCommand>("wonderwareintouchclient")
    ...
    private static void ConfigureTagCreateCommands(
        ...
        => node.AddBranch("create", create =>
        {
            ...
            create
                .AddCommand<TagsCreateTagCommand>("tag")
            ...
            create
                .AddCommand<TagsCreateTagGroupCommand>("taggroup")
    ...
    private static void ConfigureMeterGetCommands(
        ...
        => node.AddBranch("get", get =>
        {
            ...
            get
                .AddCommand<MetersGetAbbTotalflowCommand>("abbtotalflow")
            ...
            get
                .AddCommand<MetersGetFisherRocEthernetCommand>("fisherrocethernet")
            ...
            get
                .AddCommand<MetersGetFisherRocPlusEthernetCommand>("fisherrocplusethernet")
            ...
            get
                .AddCommand<MetersGetOmniFlowComputerCommand>("omniflowcomputer")
    ...
    private static void ConfigureMeterCreateCommands(
        ...
        => node.AddBranch("create", create =>
        {
            ...
            create
                .AddCommand<MeterCreateAbbTotalflowCommand>("abbtotalflow")
            ...
            create
                .AddCommand<MeterCreateFisherRocEthernetCommand>("fisherrocethernet")
            ...
            create
                .AddCommand<MeterCreateFisherRocPlusEthernetCommand>("fisherrocplusethernet")
    ...
    private static void ConfigureIotAgentMqttClientCommands(
        ...
        => node.AddBranch("mqtt-client", mqttClient =>
        {
            ...
            mqttClient
                .AddCommand<IotAgentCreateMqttClientCommand>("create")
            ...
            mqttClient
                .AddCommand<IotAgentGetMqttClientCommand>("get")
            ...
            mqttClient
                .AddCommand<IotAgentDisableCommand>("disable")
            ...
            mqttClient
                .AddCommand<IotAgentUpdateMqttClientCommand>("update")
            ...
            mqttClient
                .AddCommand<IotAgentDeleteMqttClientCommand>("delete")
    ...
    private static void ConfigureIotAgentRestClientCommands(
        ...
        => node.AddBranch("rest-client", restClient =>
        {
            ...
            restClient
                .AddCommand<IotAgentCreateRestClientCommand>("create")
            ...
            restClient
                .AddCommand<IotAgentGetRestClientCommand>("get")
            ...
            restClient
                .AddCommand<IotAgentGetAllRestClientsCommand>("all")
            ...
            restClient
                .AddCommand<IotAgentUpdateRestClientCommand>("update")
            ...
            restClient
                .AddCommand<IotAgentDeleteRestClientCommand>("delete")
    ...
    private static void ConfigureIotAgentRestServerCommands(
        ...
        => node.AddBranch("rest-server", restServer =>
        {
            ...
            restServer
                .AddCommand<IotAgentCreateRestServerCommand>("create")
            ...
            restServer
                .AddCommand<IotAgentGetRestServerCommand>("get")
            ...
            restServer
                .AddCommand<IotAgentGetAllRestServersCommand>("all")
            ...
            restServer
                .AddCommand<IotAgentUpdateRestServerCommand>("update")
            ...
            restServer
                .AddCommand<IotAgentDeleteRestServerCommand>("delete")
    ...
    private static void ConfigureIotItemMqttClientCommands(
        ...
        => node.AddBranch("mqtt-client", mqttClient =>
        {
            ...
            mqttClient
                .AddCommand<MqttClientIotItemCreateCommand>("create")
            ...
            mqttClient
                .AddCommand<IotItemGetCommand>("get")
            ...
            mqttClient
                .AddCommand<IotItemDisableCommand>("disable")
            ...
            mqttClient
                .AddCommand<MqttClientIotItemUpdateCommand>("update")
            ...
            mqttClient
                .AddCommand<IotItemDeleteCommand>("delete")
    ...
    private static void ConfigureIotItemRestClientCommands(
        ...
        => node.AddBranch("rest-client", restClient =>
        {
            ...
            restClient
                .AddCommand<RestClientIotItemCreateCommand>("create")
            ...
            restClient
                .AddCommand<RestClientIotItemUpdateCommand>("update")
    ...
    private static void ConfigureIotItemRestServerCommands(
        ...
        => node.AddBranch("rest-server", restServer =>
        {
            ...
            restServer
                .AddCommand<RestServerIotItemCreateCommand>("create")
            ...
            restServer
                .AddCommand<RestServerIotItemUpdateCommand>("update")
