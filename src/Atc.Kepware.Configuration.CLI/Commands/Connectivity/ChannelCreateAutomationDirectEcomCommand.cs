...
public sealed class ChannelCreateAutomationDirectEcomCommand : AsyncCommand<ChannelCreateAutomationDirectEcomCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateAutomationDirectEcomCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateAutomationDirectEcomCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateAutomationDirectEcomCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateAutomationDirectEcomCommandSettings settings)
    {
        ...
        ChannelCreateAutomationDirectEcomCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildAutomationDirectEcomChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateAutomationDirectEcomChannel(request, CancellationToken.None);
    ...
    private static AutomationDirectEcomChannelRequest BuildAutomationDirectEcomChannelRequest(
        ChannelCreateAutomationDirectEcomCommandSettings settings)
        => new()
        {
            Name = settings.Name,
