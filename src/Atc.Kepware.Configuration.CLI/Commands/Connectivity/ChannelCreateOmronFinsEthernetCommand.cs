...
public sealed class ChannelCreateOmronFinsEthernetCommand : AsyncCommand<ChannelCreateOmronFinsEthernetCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateOmronFinsEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateOmronFinsEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateOmronFinsEthernetCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateOmronFinsEthernetCommandSettings settings)
    {
        ...
        ChannelCreateOmronFinsEthernetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildOmronFinsEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateOmronFinsEthernetChannel(request, CancellationToken.None);
    ...
    private static OmronFinsEthernetChannelRequest BuildOmronFinsEthernetChannelRequest(
        ChannelCreateOmronFinsEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
