...
public sealed class ChannelCreateSixnetEthertrakCommand : AsyncCommand<ChannelCreateSixnetEthertrakCommandSettings>
{
    ...
    public ChannelCreateSixnetEthertrakCommand(
    ...
    public override Task<int> ExecuteAsync(
        ...
        ChannelCreateSixnetEthertrakCommandSettings settings)
    {
        ...
        ChannelCreateSixnetEthertrakCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildSixnetEthertrakChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateSixnetEthertrakChannel(request, CancellationToken.None);
    ...
    private static SixnetEthertrakChannelRequest BuildSixnetEthertrakChannelRequest(
        ChannelCreateSixnetEthertrakCommandSettings settings)
        => new()
        {
            Name = settings.Name,
