...
public sealed class ChannelCreateYaskawaMpSeriesEthernetCommand : AsyncCommand<ChannelCreateYaskawaMpSeriesEthernetCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateYaskawaMpSeriesEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateYaskawaMpSeriesEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateYaskawaMpSeriesEthernetCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateYaskawaMpSeriesEthernetCommandSettings settings)
    {
        ...
        ChannelCreateYaskawaMpSeriesEthernetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildYaskawaMpSeriesEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateYaskawaMpSeriesEthernetChannel(request, CancellationToken.None);
    ...
    private static YaskawaMpSeriesEthernetChannelRequest BuildYaskawaMpSeriesEthernetChannelRequest(
        ChannelCreateYaskawaMpSeriesEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
