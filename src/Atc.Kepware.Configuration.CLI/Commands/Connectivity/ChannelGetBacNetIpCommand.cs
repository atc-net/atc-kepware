...
public sealed class ChannelGetBacNetIpCommand : AsyncCommand<ChannelGetCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelGetBacNetIpCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelGetBacNetIpCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelGetBacNetIpCommand>();
        ...
        ChannelGetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var result = await kepwareConfigurationClient.GetBacNetIpChannel(
                settings.Name,
