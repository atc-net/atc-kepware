...
public sealed class DeviceGetModbusTcpIpEthernetCommand : AsyncCommand<ChannelAndDeviceCommandBaseSettings>
{
    private readonly ILogger<DeviceGetModbusTcpIpEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public DeviceGetModbusTcpIpEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        logger = loggerFactory.CreateLogger<DeviceGetModbusTcpIpEthernetCommand>();
