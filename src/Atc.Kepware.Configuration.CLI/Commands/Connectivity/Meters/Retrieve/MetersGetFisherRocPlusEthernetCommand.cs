...
public sealed class MetersGetFisherRocPlusEthernetCommand : AsyncCommand<MeterCommandBaseSettings>
{
    private readonly ILogger<MetersGetFisherRocPlusEthernetCommand> logger;
    ...
    {
        logger = loggerFactory.CreateLogger<MetersGetFisherRocPlusEthernetCommand>();
