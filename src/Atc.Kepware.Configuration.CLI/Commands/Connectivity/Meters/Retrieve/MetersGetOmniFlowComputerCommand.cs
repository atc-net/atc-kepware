...
public sealed class MetersGetOmniFlowComputerCommand : AsyncCommand<MeterCommandBaseSettings>
{
    private readonly ILogger<MetersGetOmniFlowComputerCommand> logger;
    ...
    {
        logger = loggerFactory.CreateLogger<MetersGetOmniFlowComputerCommand>();
