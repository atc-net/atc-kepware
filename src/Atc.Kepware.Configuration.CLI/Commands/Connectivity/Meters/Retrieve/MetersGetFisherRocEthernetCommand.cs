...
public sealed class MetersGetFisherRocEthernetCommand : AsyncCommand<MeterCommandBaseSettings>
{
    private readonly ILogger<MetersGetFisherRocEthernetCommand> logger;
    ...
    {
        logger = loggerFactory.CreateLogger<MetersGetFisherRocEthernetCommand>();
