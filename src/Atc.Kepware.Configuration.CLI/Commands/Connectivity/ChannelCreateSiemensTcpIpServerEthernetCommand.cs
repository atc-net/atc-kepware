...
public sealed class ChannelCreateSiemensTcpIpServerEthernetCommand : AsyncCommand<ChannelCreateSiemensTcpIpServerEthernetCommandSettings>
{
    ...
    public ChannelCreateSiemensTcpIpServerEthernetCommand(
    ...
    private static SiemensTcpIpServerEthernetChannelRequest BuildSiemensTcpIpServerEthernetChannelRequest(
        ChannelCreateSiemensTcpIpServerEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
