...
public sealed class ChannelCreateMitsubishiEthernetCommand : AsyncCommand<ChannelCreateMitsubishiEthernetCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateMitsubishiEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateMitsubishiEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateMitsubishiEthernetCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateMitsubishiEthernetCommandSettings settings)
    {
        ...
        ChannelCreateMitsubishiEthernetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildMitsubishiEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateMitsubishiEthernetChannel(request, CancellationToken.None);
    ...
    private static MitsubishiEthernetChannelRequest BuildMitsubishiEthernetChannelRequest(
        ChannelCreateMitsubishiEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
