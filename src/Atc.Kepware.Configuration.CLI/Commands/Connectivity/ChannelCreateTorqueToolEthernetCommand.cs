...
public sealed class ChannelCreateTorqueToolEthernetCommand : AsyncCommand<ChannelCreateCommandBaseSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateTorqueToolEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateTorqueToolEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateTorqueToolEthernetCommand>();
        ...
        ChannelCreateCommandBaseSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildTorqueToolEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateTorqueToolEthernetChannel(request, CancellationToken.None);
    ...
    private static TorqueToolEthernetChannelRequest BuildTorqueToolEthernetChannelRequest(
        ChannelCreateCommandBaseSettings settings)
        => new()
        {
            Name = settings.Name,
