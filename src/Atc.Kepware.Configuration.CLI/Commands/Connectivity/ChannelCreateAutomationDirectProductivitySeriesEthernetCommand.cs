...
public sealed class ChannelCreateAutomationDirectProductivitySeriesEthernetCommand : AsyncCommand<ChannelCreateAutomationDirectProductivitySeriesEthernetCommandSettings>
{
    ...
    public ChannelCreateAutomationDirectProductivitySeriesEthernetCommand(
    ...
    public override Task<int> ExecuteAsync(
        ...
        ChannelCreateAutomationDirectProductivitySeriesEthernetCommandSettings settings)
    {
        ...
        ChannelCreateAutomationDirectProductivitySeriesEthernetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildAutomationDirectProductivitySeriesEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateAutomationDirectProductivitySeriesEthernetChannel(request, CancellationToken.None);
    ...
    private static AutomationDirectProductivitySeriesEthernetChannelRequest BuildAutomationDirectProductivitySeriesEthernetChannelRequest(
        ChannelCreateAutomationDirectProductivitySeriesEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
