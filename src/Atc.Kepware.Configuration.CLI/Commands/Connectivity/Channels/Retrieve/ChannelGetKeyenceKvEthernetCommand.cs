...
public sealed class ChannelGetKeyenceKvEthernetCommand : AsyncCommand<ChannelGetCommandSettings>
{
    private readonly ILogger<ChannelGetKeyenceKvEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelGetKeyenceKvEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        logger = loggerFactory.CreateLogger<ChannelGetKeyenceKvEthernetCommand>();
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var result = await kepwareConfigurationClient.GetKeyenceKvEthernetChannel(
                settings.Name,
                cancellationToken);
