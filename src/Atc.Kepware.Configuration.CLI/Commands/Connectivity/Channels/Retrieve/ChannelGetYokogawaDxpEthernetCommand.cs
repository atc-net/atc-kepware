...
public sealed class ChannelGetYokogawaDxpEthernetCommand : AsyncCommand<ChannelGetCommandSettings>
{
    private readonly ILogger<ChannelGetYokogawaDxpEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelGetYokogawaDxpEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        logger = loggerFactory.CreateLogger<ChannelGetYokogawaDxpEthernetCommand>();
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var result = await kepwareConfigurationClient.GetYokogawaDxpEthernetChannel(
                settings.Name,
                cancellationToken);
