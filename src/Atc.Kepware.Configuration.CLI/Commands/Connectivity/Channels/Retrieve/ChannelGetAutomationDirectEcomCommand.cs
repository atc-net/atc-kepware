...
public sealed class ChannelGetAutomationDirectEcomCommand : AsyncCommand<ChannelGetCommandSettings>
{
    private readonly ILogger<ChannelGetAutomationDirectEcomCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelGetAutomationDirectEcomCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        logger = loggerFactory.CreateLogger<ChannelGetAutomationDirectEcomCommand>();
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var result = await kepwareConfigurationClient.GetAutomationDirectEcomChannel(
                settings.Name,
                cancellationToken);
