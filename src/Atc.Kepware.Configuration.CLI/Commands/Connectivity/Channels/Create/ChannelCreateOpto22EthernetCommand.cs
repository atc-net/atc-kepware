...
public sealed class ChannelCreateOpto22EthernetCommand : AsyncCommand<ChannelCreateOpto22EthernetCommandSettings>
{
    private readonly ILogger<ChannelCreateOpto22EthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateOpto22EthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        logger = loggerFactory.CreateLogger<ChannelCreateOpto22EthernetCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateOpto22EthernetCommandSettings settings,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var request = BuildOpto22EthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateOpto22EthernetChannel(request, cancellationToken);
    ...
    private static Opto22EthernetChannelRequest BuildOpto22EthernetChannelRequest(
        ChannelCreateOpto22EthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
