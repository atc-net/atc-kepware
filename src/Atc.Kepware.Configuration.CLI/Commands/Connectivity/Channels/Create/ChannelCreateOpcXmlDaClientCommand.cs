...
public sealed class ChannelCreateOpcXmlDaClientCommand : AsyncCommand<ChannelCreateOpcXmlDaClientCommandSettings>
{
    private readonly ILogger<ChannelCreateOpcXmlDaClientCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateOpcXmlDaClientCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        logger = loggerFactory.CreateLogger<ChannelCreateOpcXmlDaClientCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateOpcXmlDaClientCommandSettings settings,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var request = BuildOpcXmlDaClientChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateOpcXmlDaClientChannel(request, cancellationToken);
    ...
    private static OpcXmlDaClientChannelRequest BuildOpcXmlDaClientChannelRequest(
        ChannelCreateOpcXmlDaClientCommandSettings settings)
        => new()
        {
            Name = settings.Name,
            ...
            ServerUrl = settings.OpcXmlDaServerUrl,
