...
public sealed class ChannelCreateWonderwareIntouchClientCommand : AsyncCommand<ChannelCreateWonderwareIntouchClientCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateWonderwareIntouchClientCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateWonderwareIntouchClientCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateWonderwareIntouchClientCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateWonderwareIntouchClientCommandSettings settings)
    {
        ...
        ChannelCreateWonderwareIntouchClientCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildWonderwareIntouchClientChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateWonderwareIntouchClientChannel(request, CancellationToken.None);
    ...
    private static WonderwareIntouchClientChannelRequest BuildWonderwareIntouchClientChannelRequest(
        ChannelCreateWonderwareIntouchClientCommandSettings settings)
        => new()
        {
            Name = settings.Name,
