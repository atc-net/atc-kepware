...
public sealed class ChannelCreateBuswareEthernetCommand : AsyncCommand<ChannelCreateBuswareEthernetCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateBuswareEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateBuswareEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateBuswareEthernetCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateBuswareEthernetCommandSettings settings)
    {
        ...
        ChannelCreateBuswareEthernetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildBuswareEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateBuswareEthernetChannel(request, CancellationToken.None);
    ...
    private static BuswareEthernetChannelRequest BuildBuswareEthernetChannelRequest(
        ChannelCreateBuswareEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
            ...
            // Busware Ethernet Specific Settings
