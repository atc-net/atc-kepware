...
public sealed class ChannelCreateFanucFocasEthernetCommand : AsyncCommand<ChannelCreateFanucFocasEthernetCommandSettings>
{
    private readonly ILoggerFactory loggerFactory;
    private readonly ILogger<ChannelCreateFanucFocasEthernetCommand> logger;
    private readonly IKepwareConfigurationClient kepwareConfigurationClient;

    public ChannelCreateFanucFocasEthernetCommand(
        ILoggerFactory loggerFactory,
        IKepwareConfigurationClient kepwareConfigurationClient)
    {
        this.loggerFactory = loggerFactory;
        logger = loggerFactory.CreateLogger<ChannelCreateFanucFocasEthernetCommand>();
        this.kepwareConfigurationClient = kepwareConfigurationClient;
    }

    public override Task<int> ExecuteAsync(
        CommandContext context,
        ChannelCreateFanucFocasEthernetCommandSettings settings)
    {
        ...
        ChannelCreateFanucFocasEthernetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildFanucFocasEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateFanucFocasEthernetChannel(request, CancellationToken.None);
    ...
    private static FanucFocasEthernetChannelRequest BuildFanucFocasEthernetChannelRequest(
        ChannelCreateFanucFocasEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
