...
public sealed class ChannelCreateCutlerHammerElcEthernetCommand : AsyncCommand<ChannelCreateCutlerHammerElcEthernetCommandSettings>
{
    ...
    public ChannelCreateCutlerHammerElcEthernetCommand(
    ...
    public override Task<int> ExecuteAsync(
        ...
        ChannelCreateCutlerHammerElcEthernetCommandSettings settings)
    {
        ...
        ChannelCreateCutlerHammerElcEthernetCommandSettings settings)
    {
        ...
        try
        {
            ...
            var request = BuildCutlerHammerElcEthernetChannelRequest(settings);
            var result = await kepwareConfigurationClient.CreateCutlerHammerElcEthernetChannel(request, CancellationToken.None);
    ...
    private static CutlerHammerElcEthernetChannelRequest BuildCutlerHammerElcEthernetChannelRequest(
        ChannelCreateCutlerHammerElcEthernetCommandSettings settings)
        => new()
        {
            Name = settings.Name,
