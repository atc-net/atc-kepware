namespace Atc.Kepware.Configuration.CLI.Commands.IotGateway.IotAgent.EnableDisable;

public sealed class IotAgentEnableCommand : AsyncCommand<IotAgentCommandBaseSettings>
{
