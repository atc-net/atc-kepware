...
namespace Atc.Kepware.Configuration.CLI.Commands.IotGateway.IotAgent.Update;

public sealed class IotAgentUpdateRestClientCommand : AsyncCommand<IotAgentUpdateRestClientCommandSettings>
{
