...
/// <summary>
/// Yokogawa MX Ethernet device request - Kepware format.
/// </summary>
internal sealed class YokogawaMxEthernetDeviceRequest : DeviceRequestBase, IYokogawaMxEthernetDeviceRequest
{
