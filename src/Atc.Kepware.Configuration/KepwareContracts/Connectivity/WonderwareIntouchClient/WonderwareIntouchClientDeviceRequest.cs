...
/// <summary>
/// Device request properties for the Wonderware InTouch Client driver.
/// </summary>
internal sealed class WonderwareIntouchClientDeviceRequest : DeviceRequestBase, IWonderwareIntouchClientDeviceRequest
{
