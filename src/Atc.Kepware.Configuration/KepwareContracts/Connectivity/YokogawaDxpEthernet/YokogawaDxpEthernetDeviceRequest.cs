...
/// <summary>
/// Yokogawa DXP Ethernet device request - Kepware format.
/// </summary>
internal sealed class YokogawaDxpEthernetDeviceRequest : DeviceRequestBase, IYokogawaDxpEthernetDeviceRequest
{
