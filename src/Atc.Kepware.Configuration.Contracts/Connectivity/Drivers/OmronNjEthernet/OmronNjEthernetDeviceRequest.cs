...
/// <summary>
/// Omron NJ Ethernet device request.
/// </summary>
public class OmronNjEthernetDeviceRequest : DeviceRequestBase, IOmronNjEthernetDeviceRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OmronNjEthernetDeviceRequest"/> class.
    /// </summary>
