...
/// <summary>
/// Defines the AutomationDirect Productivity Series Ethernet device properties.
/// </summary>
public interface IAutomationDirectProductivitySeriesEthernetDevice : IDeviceBase
{
    /// <summary>
