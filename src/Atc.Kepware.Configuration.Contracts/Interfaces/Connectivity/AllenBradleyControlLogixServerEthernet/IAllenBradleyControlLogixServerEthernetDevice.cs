...
public interface IAllenBradleyControlLogixServerEthernetDevice : IDeviceBase
{
    /// <summary>
    ...
    /// <summary>
    /// The routing path to the controller module configured in the ControlLogix client device.
    /// </summary>
    /// <remarks>
    /// This is a read-only property provided for reference.
    /// </remarks>
    string? Path { get; }
