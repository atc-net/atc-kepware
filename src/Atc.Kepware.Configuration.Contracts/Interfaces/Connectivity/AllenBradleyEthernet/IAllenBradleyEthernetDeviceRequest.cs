...
/// <summary>
/// Defines the Allen-Bradley Ethernet device request properties.
/// </summary>
public interface IAllenBradleyEthernetDeviceRequest : IDeviceRequestBase
{
    /// <summary>
    ...
    /// </remarks>
    IList<AllenBradleyEthernetSlotConfiguration>? SlotConfiguration { get; }
}